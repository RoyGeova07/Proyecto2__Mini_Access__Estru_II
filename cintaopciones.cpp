...
static QString estiloCinta()
{
    ...
    return R"(
    /* Secciones (Inicio / Crear / Herramientas BD) */
    ...
    /* Acciones (botones grandes con icono) */
    ...
    /*Flecha/area del menu (siempre visible sobre fondo claro) */
    ...
    /*Menu desplegable coherente con fondo claro*/
