...
public:
    ...
    RelationItem(TableItem* origen, const QString& campoOrigen,TableItem* destino, const QString& campoDestino,bool unoAMuchos = true, bool integridad = true,QGraphicsItem* parent = nullptr);
