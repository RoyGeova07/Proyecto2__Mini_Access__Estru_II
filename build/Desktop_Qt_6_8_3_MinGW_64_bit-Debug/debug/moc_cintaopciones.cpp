...
static constexpr auto qt_meta_stringdata_ZN13CintaOpcionesE = QtMocHelpers::stringData(
    ...
    "ConsultaPulsado",
    "agregarTablaHBDPulsado",
    "eliminarTablasRelPulsado",
    "cambiarSeccion",
    "Seccion",
    "s",
...
Q_CONSTINIT static const uint qt_meta_data_ZN13CintaOpcionesE[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       8,    0,  122,    2, 0x06,    7 /* Public */,
       9,    0,  123,    2, 0x06,    8 /* Public */,
      10,    0,  124,    2, 0x06,    9 /* Public */,
      11,    0,  125,    2, 0x06,   10 /* Public */,
      12,    0,  126,    2, 0x06,   11 /* Public */,
      13,    0,  127,    2, 0x06,   12 /* Public */,
      14,    0,  128,    2, 0x06,   13 /* Public */,

 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      15,    1,  129,    2, 0x0a,   14 /* Public */,
      18,    1,  132,    2, 0x0a,   16 /* Public */,
      20,    0,  135,    2, 0x0a,   18 /* Public */,
      21,    0,  136,    2, 0x0a,   19 /* Public */,
...
Q_CONSTINIT const QMetaObject CintaOpciones::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13CintaOpcionesE_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'agregarTablaHBDPulsado'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'eliminarTablasRelPulsado'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void CintaOpciones::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 11: _t->agregarTablaHBDPulsado(); break;
        case 12: _t->eliminarTablasRelPulsado(); break;
        case 13: _t->cambiarSeccion((*reinterpret_cast< std::add_pointer_t<Seccion>>(_a[1]))); break;
        case 14: _t->MostrarBotonClavePrimaria((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 15: _t->setIconoVerHojaDatos(); break;
        case 16: _t->setIconoVerDisenio(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_q_method_type _q_method = &CintaOpciones::eliminarTablaPulsado; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        ...
        {
            using _q_method_type = void (CintaOpciones::*)();
            if (_q_method_type _q_method = &CintaOpciones::agregarColumnaPulsado; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 7;
                return;
            }
        }
        {
            using _q_method_type = void (CintaOpciones::*)();
            if (_q_method_type _q_method = &CintaOpciones::eliminarColumnaPulsado; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 8;
                return;
            }
        }
        {
            using _q_method_type = void (CintaOpciones::*)();
            if (_q_method_type _q_method = &CintaOpciones::ClavePrimarioPulsado; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 9;
                return;
            }
        }
        {
            using _q_method_type = void (CintaOpciones::*)();
            if (_q_method_type _q_method = &CintaOpciones::ConsultaPulsado; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 10;
                return;
            }
        }
        {
            using _q_method_type = void (CintaOpciones::*)();
            if (_q_method_type _q_method = &CintaOpciones::agregarTablaHBDPulsado; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 11;
                return;
            }
        }
        {
            using _q_method_type = void (CintaOpciones::*)();
            if (_q_method_type _q_method = &CintaOpciones::eliminarTablasRelPulsado; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 12;
                return;
            }
        }
...
// SIGNAL 11
void CintaOpciones::agregarTablaHBDPulsado()
{
    QMetaObject::activate(this, &staticMetaObject, 11, nullptr);
}

// SIGNAL 12
void CintaOpciones::eliminarTablasRelPulsado()
{
