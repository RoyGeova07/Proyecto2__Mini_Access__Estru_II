...
namespace {
struct qt_meta_tag_ZN12PanelObjetosE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12PanelObjetosE = QtMocHelpers::stringData(
    "PanelObjetos",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12PanelObjetosE[] = {
...
Q_CONSTINIT const QMetaObject PanelObjetos::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12PanelObjetosE.offsetsAndSizes,
    qt_meta_data_ZN12PanelObjetosE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12PanelObjetosE_t,
        // Q_OBJECT / Q_GADGET
...
void PanelObjetos::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->filtrar((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_q_method_type _q_method = &PanelObjetos::tablaAbiertaSolicitada; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *PanelObjetos::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12PanelObjetosE.stringdata0))
