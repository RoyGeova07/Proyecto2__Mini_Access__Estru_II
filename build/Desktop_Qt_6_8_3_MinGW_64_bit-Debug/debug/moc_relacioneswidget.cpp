...
Q_CONSTINIT const QMetaObject RelacionesWidget::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16RelacionesWidgetE_t,
        ...
        // method 'snapshotActualizado'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QMap<QString,RelDef> &, std::false_type>
    >,
    nullptr
} };
...
void RelacionesWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->snapshotActualizado((*reinterpret_cast< std::add_pointer_t<QMap<QString,RelDef>>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (RelacionesWidget::*)(const QMap<QString,RelDef> & );
            if (_q_method_type _q_method = &RelacionesWidget::snapshotActualizado; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RelacionesWidget::snapshotActualizado(const QMap<QString,RelDef> & _t1)
{
